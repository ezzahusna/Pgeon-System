...
<% List<dispatch.Dispatch> lis = dispatchModel.viewDispatch(); %>
...
<br><br><center>
<h3 class="title-line" style="text-transform:inherit; font-size:42px;">Schedule</h3>
</center><br><br>
</section>
...
<%
  ...
  <option value="volvo">Amin</option>
  <option value="saab">Najmi</option>
  <option value="mercedes">Ahmad</option>
</select></td>
	<td><select name="cars" id="cars">
  <option value="volvo">On hold</option>
  <option value="saab">On delivery</option>
